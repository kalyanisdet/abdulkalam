...
public class FramesPractice16 {
	...
	public static void main(String[] args) throws Exception{
		...
		Thread.sleep(5000);
		WebElement webElement= driver.findElement(By.xpath("//span[@class='B_NuCI']"));
		...
		System.out.println("Get all the cameras name & types successfully.");
